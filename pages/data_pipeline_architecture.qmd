...
| Metadata/catalog | **Microsoft Purview** if your organization uses it; otherwise static metadata files + landing page | Purview is Azure's governed data catalog/data estate tool and supports metadata, lineage, access policies, data quality concepts, and data discovery. |
